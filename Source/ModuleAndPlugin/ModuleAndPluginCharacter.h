...
class AModuleAndPluginCharacter : public ACharacter
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = SpawnActor, meta = (AllowPrivateAccess = "true"))
	TSubclassOf<AModuleActorBase> SpawnActorClass;
public:
